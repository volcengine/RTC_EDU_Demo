...
public class EduStreamManager extends AbsEduManager implements IRtcListener {

    private static final String TAG = "EduStreamManager";
    ...
    public EduStreamManager(@NonNull UIRtcCore uiRtcCore, @NonNull EduRoomImpl uiRoom, @NonNull EduDataProviderImpl dataProvider, @NonNull RTCRoom rtcRoom) {
