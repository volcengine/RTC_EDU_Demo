...
public interface IMeetingRtmEventHandler {
     ...
     * @param info
     */
    default void onJoinRoom(MeetingTokenInfo info) {
    }
     ...
     * @param userCount
     */
    default void onRemoteUserJoin(@NonNull MeetingUserInfo user, int userCount) {
    }
     ...
     * @param userCount
     */
    default void onRemoteUserLeave(@NonNull MeetingUserInfo user, int userCount) {
    }
     ...
     * @param userName
     */
    default void onShareStarted(int shareType, @NonNull String userId, String userName) {
    }
     ...
     * @param userId user Id
     */
    default void onShareStopped(@NonNull String userId) {
    }
    ...
    default void onHostChange(String roomId, String userId) {
    }
}
