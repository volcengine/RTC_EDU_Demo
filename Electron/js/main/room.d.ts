...
import { UserInfo, RTCRoomConfig, RemoteVideoConfig, MediaStreamType, PauseResumeControlMediaType, MessageConfig, ForwardStreamConfiguration, ReceiveRange, Position, AttenuationType, HumanOrientation, AudioSelectionPriority, SubtitleConfig, PositionInfo } from "../types";
import { EventType, RTCROOMCALLBACK } from "../types/common";
/** {en}
 * @list 85530
 * @detail 85532
 */
 ...
 * @detail 85532
 */
declare class RTCRoom extends EventEmitter {
    private instance;
    private roomId;
    private localUser;
    private remoteUsers;
     ...
     */
    createRTCRoom(room_id: string): -1 | 0;
    /** {en}
     * @brief Get room ID
     * @returns Room ID
     */
     ...
     */
    joinRoom(token: string, user_info: UserInfo, config?: RTCRoomConfig): number;
    /** {en}
     ...
     */
    setUserVisibility(enable: Boolean): number;
    /** {en}
     ...
     */
    setMultiDeviceAVSync(audio_user_id: string): number;
    /** {en}
     ...
     */
    setRemoteVideoConfig(user_id: string, remote_video_config: RemoteVideoConfig): number;
    /** {en}
     ...
     */
    publishScreen(type: MediaStreamType): number;
    /** {en}
     ...
     */
    subscribeStream(user_id: string, type: MediaStreamType): number;
    /** {en}
     ...
     */
    unsubscribeStream(user_id: string, type: MediaStreamType): number;
    /** {en}
     ...
     * + 关于其他调用异常，你会收到 [onStreamStateChanged](85533#onstreamstatechanged) 回调通知，具体异常原因参看 [ErrorCode](85534#errorcode)。
     */
    subscribeScreen(user_id: string, type: MediaStreamType): number;
    /** {en}
     ...
     * + 关于其他调用异常，你会收到 [onStreamStateChanged](85533#onstreamstatechanged) 回调通知，具体失败原因参看 [ErrorCode](85534#errorcode)。
     */
    unsubscribeScreen(user_id: string, type: MediaStreamType): number;
    /** {en}
     ...
     */
    pauseAllSubscribedStream(media_type: PauseResumeControlMediaType): number;
    /** {en}
     ...
     * + 该方法不改变用户的订阅状态以及订阅流的属性。
     */
    resumeAllSubscribedStream(media_type: PauseResumeControlMediaType): number;
    /** {en}
     ...
     */
    sendUserMessage(uid: string, message: string, config: MessageConfig): number;
    /** {en}
     ...
     */
    sendUserBinaryMessage(uid: string, length: number, message: Uint8Array, config: MessageConfig): number;
    /** {en}
     ...
     */
    sendRoomMessage(message: string): number;
    /** {en}
     * @brief Send broadcast messages to all other users in the room.
     ...
     */
    sendRoomBinaryMessage(size: number, message: Uint8Array): number;
    /** {en}
     ...
     */
    startForwardStreamToRooms(configuration: ForwardStreamConfiguration): number;
    /** {en}
     ...
     */
    updateForwardStreamToRooms(configuration: ForwardStreamConfiguration): number;
    /** {en}
     ...
     */
    enableRangeAudio(enable: boolean): number;
    /** {en}
     ...
     * + `!0`: 失败。
     */
    updateReceiveRange(range: ReceiveRange): number;
    /** {en}
     ...
     */
    updateRangePosition(pos: Position): number;
    /** {en}
     ...
     * @param flags 标签组
     */
    setNoAttenuationFlags(flags?: string[]): any;
    /** {en}
     ...
     */
    enableSpatialAudio(enable: boolean): number;
    /** {en}
     * @brief Updates the coordinate of the local user's position in the rectangular coordinate system in the current room.
     ...
     */
    updateSpatialPosition(pos: Position): number;
    /** {en}
     ...
     */
    updateSelfOrientation(orientation: HumanOrientation): number;
    /** {en}
     ...
     */
    disableRemoteOrientation(): number;
    /** {en}
     ...
     */
    updateListenerPosition(pos: Position): number;
    /** {en}
     ...
     * @notes 空间音频相关 API 和调用时序详见[空间音频](https://www.volcengine.com/docs/6348/93903)。
     */
    updateListenerOrientation(orientation: HumanOrientation): number;
    /** {en}
     ...
     */
    setAudioSelectionConfig(audio_selection_priority: AudioSelectionPriority): number;
    /** {en}
     ...
     */
    setRoomExtraInfo(key: string, value: string): any;
    /** {en}
     ...
     */
    startSubtitle(subtitle_config: SubtitleConfig): number;
    /** {en}
     * @hidden currently not available
     ...
     */
    updateSelfPosition(position_info: PositionInfo): number;
    /** {en}
     ...
     *        调用此接口在本地进行的设定对其他用户的空间音频收听效果不会产生任何影响。
     */
    updateRemotePosition(uid: string, position_info: PositionInfo): number;
    /** {en}
     ...
     *         + `<0`：失败。
     */
    removeRemotePosition(uid: string): number;
    /** {en}
     ...
     *         + `<0`：失败。
     */
    removeAllRemotePosition(): number;
    /**
     * @private
     */
...
declare interface RTCRoom {
    on(evt: "onRoomStateChanged", cb: RTCROOMCALLBACK["onRoomStateChanged"]): this;
    on(evt: "onStreamStateChanged", cb: RTCROOMCALLBACK["onStreamStateChanged"]): this;
    on(evt: "onLeaveRoom", cb: RTCROOMCALLBACK["onLeaveRoom"]): this;
    on(evt: "onUserJoined", cb: RTCROOMCALLBACK["onUserJoined"]): this;
    on(evt: "onUserLeave", cb: RTCROOMCALLBACK["onUserLeave"]): this;
    on(evt: "onTokenWillExpire", cb: RTCROOMCALLBACK["onTokenWillExpire"]): this;
    on(evt: "onAVSyncStateChange", cb: RTCROOMCALLBACK["onAVSyncStateChange"]): this;
    on(evt: "onRoomStats", cb: RTCROOMCALLBACK["onRoomStats"]): this;
    on(evt: "onLocalStreamStats", cb: RTCROOMCALLBACK["onLocalStreamStats"]): this;
    on(evt: "onRemoteStreamStats", cb: RTCROOMCALLBACK["onRemoteStreamStats"]): this;
    on(evt: "onUserPublishStream", cb: RTCROOMCALLBACK["onUserPublishStream"]): this;
    on(evt: "onUserUnpublishStream", cb: RTCROOMCALLBACK["onUserUnpublishStream"]): this;
    on(evt: "onUserPublishScreen", cb: RTCROOMCALLBACK["onUserPublishScreen"]): this;
    on(evt: "onUserUnpublishScreen", cb: RTCROOMCALLBACK["onUserUnpublishScreen"]): this;
    on(evt: "onStreamSubscribed", cb: RTCROOMCALLBACK["onStreamSubscribed"]): this;
    on(evt: "onVideoStreamBanned", cb: RTCROOMCALLBACK["onVideoStreamBanned"]): this;
    on(evt: "onAudioStreamBanned", cb: RTCROOMCALLBACK["onAudioStreamBanned"]): this;
    on(evt: "onRoomMessageReceived", cb: RTCROOMCALLBACK["onRoomMessageReceived"]): this;
    on(evt: "onRoomBinaryMessageReceived", cb: RTCROOMCALLBACK["onRoomBinaryMessageReceived"]): this;
    on(evt: "onUserMessageReceived", cb: RTCROOMCALLBACK["onUserMessageReceived"]): this;
    on(evt: "onUserBinaryMessageReceived", cb: RTCROOMCALLBACK["onUserBinaryMessageReceived"]): this;
    on(evt: "onUserMessageSendResult", cb: RTCROOMCALLBACK["onUserMessageSendResult"]): this;
    on(evt: "onRoomMessageSendResult", cb: RTCROOMCALLBACK["onRoomMessageSendResult"]): this;
    on(evt: "onForwardStreamStateChanged", cb: RTCROOMCALLBACK["onForwardStreamStateChanged"]): this;
    on(evt: "onForwardStreamEvent", cb: RTCROOMCALLBACK["onForwardStreamEvent"]): this;
    on(evt: "onNetworkQuality", cb: RTCROOMCALLBACK["onNetworkQuality"]): this;
    on(evt: "onPublishPrivilegeTokenWillExpire", cb: RTCROOMCALLBACK["onPublishPrivilegeTokenWillExpire"]): this;
    on(evt: "onSubscribePrivilegeTokenWillExpire", cb: RTCROOMCALLBACK["onSubscribePrivilegeTokenWillExpire"]): this;
    on(evt: "onSetRoomExtraInfoResult", cb: RTCROOMCALLBACK["onSetRoomExtraInfoResult"]): this;
    on(evt: "onRoomExtraInfoUpdate", cb: RTCROOMCALLBACK["onRoomExtraInfoUpdate"]): this;
    on(evt: "onSubtitleStateChanged", cb: RTCROOMCALLBACK["onSubtitleStateChanged"]): this;
    on(evt: "onSubtitleMessageReceived", cb: RTCROOMCALLBACK["onSubtitleMessageReceived"]): this;
    on(evt: "onUserVisibilityChanged", cb: RTCROOMCALLBACK["onUserVisibilityChanged"]): this;
}
