...
type CBNAME = 'empty' | 'handleReqOpenShare' | 'handleComfirmOpenMic' | 'handleConfirmOpenCamera';

// 参会人申请开麦、申请共享、回应主持人打开摄像头和麦克风操作
