...
import { appendRemoteUsers, EdubRoomState, IEdubUser } from '@src/store/slices/edubRoom';
import UserItemInfo, { ItemUserInfo, UserItemInfoProps } from '../../components/UserItemInfo';
import { isRtsError } from '@/renderer/utils/rtsUtils';
import * as rtsApi from '../../apis/rtsApi';
import { sortUserByRole } from '@/renderer/utils/useSortUser';
...
function UserList(props: UserListProps) {
  ...
  const localIsHost = room.localUser.user_role === UserRole.Host;
