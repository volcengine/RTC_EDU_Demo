...
import PlayerLayout from './PlayerWrapper/PlayerLayout';
  ...
  useEffect(() => {
    if (meShareScreen) {
      if (
        ...
        // 学生在共享屏幕状态下收到老师开麦和摄像头申请，打开modal窗口
