...
interface ScreenListModalProps {
  ...
  screenListInfo: {
    // https://www.volcengine.com/docs/6348/85535#screencapturesourceinfo
...
const ScreenListModal: React.FC<ScreenListModalProps> = (props) => {
  ...
  const handleScreenShare = (screenInfo: ScreenCaptureSourceInfo) => {
    if (screenInfo) {
      console.log('handleScreenShare', screenInfo);
      ...
      ipcRenderer.once('mainWindowChangeFinish', (e, mid, screenHeight) => {
        ...
        } satisfies ScreenCaptureParameters;
        console.log('startScreenVideoCapture:', screenInfo, params);
        RtcClient?.startScreenVideoCapture(screenInfo, params);
