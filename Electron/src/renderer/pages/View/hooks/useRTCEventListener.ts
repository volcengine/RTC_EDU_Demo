...
import { localUserJoinRoom, localUserLeaveRoom } from '@/renderer/store/slices/meetingRoom';
...
const useRTCEventListener = (screenRef: React.MutableRefObject<HTMLDivElement | null>) => {
