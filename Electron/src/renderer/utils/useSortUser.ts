...
import { Silence, UserRole } from '@src/types/state';
...
//     camera: 0,
//     mic: 1,
//     operate_camera_permission: 1,
//     operate_mic_permission: 1,
//     share_status: 0,
//     share_type: 0,
//     share_permission: 1,
//     join_time: 1678896208976491,
//   },
//   {
//     room_id: '222',
//     user_id: '2',
...
const useSortUser = (props: {
  ...
  const { localUser, curPage, pageSize, remoteUsers, activeSpeakers, shareUserId } = props;
  let { visibility } = useParams<{ visibility?: string }>();

  //   let remoteUsers = mock;
