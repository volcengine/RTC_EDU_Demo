...
@class EduBigClassRTCManager;

@protocol EduBigClassRTCManagerDelegate <NSObject>
- (void)eduBigClassRTCManager:(EduBigClassRTCManager *_Nullable)rtcManager changeParamInfo:(EduBCRoomParamInfoModel *_Nullable)model;
- (void)rtcManager:(EduBigClassRTCManager * _Nonnull)rtcManager didStreamAdded:(NSString *_Nullable)streamsUid;
- (void)rtcManager:(EduBigClassRTCManager * _Nonnull)rtcManager didScreenStreamAdded:(NSString *_Nullable)screenStreamsUid;
- (void)rtcManager:(EduBigClassRTCManager *_Nonnull)rtcManager didStreamRemoved:(NSString *_Nullable)streamsUid;
- (void)rtcManager:(EduBigClassRTCManager *_Nonnull)rtcManager didScreenStreamRemoved:(NSString *_Nullable)screenStreamsUid;
- (void)rtcManager:(EduBigClassRTCManager *_Nonnull)rtcManager reportAllAudioVolume:(NSDictionary<NSString *, NSNumber *> *_Nonnull)volumeInfo;
@end

@interface EduBigClassRTCManager : BaseRTCManager

@property (nonatomic, weak) id<EduBigClassRTCManagerDelegate> _Nullable delegate;
 ...
 */
- (void)joinChannelWithSession:(EduBCRoomVideoSession *_Nullable)videoSession token:(NSString *_Nullable)token;
