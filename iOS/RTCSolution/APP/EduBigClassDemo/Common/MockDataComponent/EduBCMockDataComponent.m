...
@interface EduBCMockDataComponent ()
...
@implementation EduBCMockDataComponent
...
- (NSRange)selectBitRateRangWithRow:(NSInteger)row {
    ...
    NSInteger bitRate = [EduBCSettingsService getKBitRate];
    ...
    [EduBCSettingsService setKBitRate:(int)bitRate];
...
- (NSRange)selectScreenBitRateRangWithRow:(NSInteger)row isDefault:(BOOL)isDefault {
    ...
    if (!isDefault) {
        [EduBCSettingsService setScreenKBitRate:(int)bitRate];
    }
