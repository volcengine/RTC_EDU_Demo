...
#import "EduBCFeedbackInputView.h"
#import "EduBigClassRTCManager.h"

@interface EduBCFeedbackView ()
...
@property (nonatomic, strong) EduBCFeedbackInputView *collectOpinionsTextField;
...
@implementation EduBCFeedbackView
...
- (void)initFeedBackUIComponent {
    ...
    [self.feedbackGoodBtn setImage:[ThemeManager imageNamed:@"meeting_feed_good"] forState:UIControlStateNormal];
    ...
    goodLabel.text = @"好";
    goodLabel.textColor = [ThemeManager buttonDescLabelTextColor];
    ...
    [self.feedbackBadBtn setImage:[ThemeManager imageNamed:@"meeting_feed_bad"] forState:UIControlStateNormal];
    ...
    badLabel.text = @"差";
    badLabel.textColor = [ThemeManager buttonDescLabelTextColor];
    ...
    [self.feedbackCloseBtn setImage:[ThemeManager imageNamed:@"meeting_feed_cancel"] forState:UIControlStateNormal];
    ...
    self.collectOpinionsTextField = [[EduBCFeedbackInputView alloc] init];
    ...
    self.collectOpinionsTextField.backgroundColor = [ThemeManager backgroundColor];
...
- (UIView *)lineView {
    if (!_lineView) {
        ...
        _lineView.backgroundColor = [ThemeManager buttonDescLabelTextColor];
    }
    return _lineView;
}
