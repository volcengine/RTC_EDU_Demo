...
@interface EduBCRoomParamInfoView ()
...
@implementation EduBCRoomParamInfoView
...
- (void)setParamInfoModel:(EduBCRoomParamInfoModel *)paramInfoModel {
    _paramInfoModel = paramInfoModel;

}

- (NSString *)getMeessageWithModel:(EduBCRoomParamInfoModel *)paramInfoModel index:(NSInteger)index {
    NSString *str = @"";
    switch (index) {
        case 0:
            str = @"[LOCAL]";
