...
@interface EduBCRoomSpeakerView ()
@property (nonatomic, strong) EduBCRoomUserView *focusedView;
@property (nonatomic, strong) EduBCRoomUserView *zoomOutView;
@property (nonatomic, assign) BOOL layoutSwapped;

@property (nonatomic, strong) EduBCRoomVideoSession *focusedVideoSession;
@property (nonatomic, strong) EduBCRoomVideoSession *zoomOutVideoSession;

@end

@implementation EduBCRoomSpeakerView
...
- (void)bindVideoSessions:(NSArray<EduBCRoomVideoSession *> *)videoSessions {
    ...
    NSArray<EduBCRoomVideoSession *> *list = videoSessions;
...
- (void)setFocusedVideoSession:(EduBCRoomVideoSession *)focusedVideoSession {
...
- (void)setZoomOutVideoSession:(EduBCRoomVideoSession *)zoomOutVideoSession {
...
- (EduBCRoomUserView *)focusedView {
    if (!_focusedView) {
        _focusedView = [[EduBCRoomUserView alloc] init];
...
- (EduBCRoomUserView *)zoomOutView {
    if (!_zoomOutView) {
        _zoomOutView = [[EduBCRoomUserView alloc] init];
