...
@interface EduBCSettingsRightLabelCell ()
...
@implementation EduBCSettingsRightLabelCell
...
- (UIImageView *)moreImageView {
    if (!_moreImageView) {
        ...
        _moreImageView.image = [ThemeManager imageNamed:@"meeting_set_more"];
    }
...
- (UILabel *)settingsRightLabel {
    if (!_settingsRightLabel) {
        ...
        _settingsRightLabel.textColor = [ThemeManager buttonDescLabelTextColor];
