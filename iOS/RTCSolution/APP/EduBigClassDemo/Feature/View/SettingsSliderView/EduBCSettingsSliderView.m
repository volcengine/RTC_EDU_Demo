...
@interface EduBCSettingsSliderView ()
...
@implementation EduBCSettingsSliderView
...
- (UILabel *)unitLabel {
    if (!_unitLabel) {
        ...
        _unitLabel.textColor = [ThemeManager buttonDescLabelTextColor];
    }
    return _unitLabel;
}
