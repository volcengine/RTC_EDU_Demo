...
#import "EduBCUserCell.h"
#import "Masonry.h"
#import "Core.h"

@interface EduBCUserCell ()
...
- (void)setModel:(EduBCMenuCellModel *)model {
    _model = model;
...
- (UILabel *)desTitleLabel {
    if (!_desTitleLabel) {
        ...
        _desTitleLabel.textColor = [ThemeManager commomDescLabelTextColor];
