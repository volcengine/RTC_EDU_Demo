...
@interface EduSCMockDataComponent ()
...
@implementation EduSCMockDataComponent
...
- (NSRange)selectBitRateRangWithRow:(NSInteger)row {
    ...
    NSInteger bitRate = [EduSCSettingsService getKBitRate];
    ...
    [EduSCSettingsService setKBitRate:(int)bitRate];
...
- (NSRange)selectScreenBitRateRangWithRow:(NSInteger)row isDefault:(BOOL)isDefault {
    ...
    if (!isDefault) {
        [EduSCSettingsService setScreenKBitRate:(int)bitRate];
    }
