//
//  EduSmallClassPickerComponent.m
//  quickstart
//
...
@interface EduSmallClassPickerComponent () <UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation EduSmallClassPickerComponent
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:[ThemeManager buttonDescLabelTextColor] forState:UIControlStateNormal];
    }
