...
@class EduSmallClassRTCManager;

@protocol EduSmallClassRTCManagerDelegate <NSObject>
- (void)eduSmallClassRTCManager:(EduSmallClassRTCManager *_Nullable)rtcManager changeParamInfo:(EduSCRoomParamInfoModel *_Nullable)model;
- (void)rtcManager:(EduSmallClassRTCManager * _Nonnull)rtcManager didStreamAdded:(NSString *_Nullable)streamsUid;
- (void)rtcManager:(EduSmallClassRTCManager * _Nonnull)rtcManager didScreenStreamAdded:(NSString *_Nullable)screenStreamsUid;
- (void)rtcManager:(EduSmallClassRTCManager *_Nonnull)rtcManager didStreamRemoved:(NSString *_Nullable)streamsUid;
- (void)rtcManager:(EduSmallClassRTCManager *_Nonnull)rtcManager didScreenStreamRemoved:(NSString *_Nullable)screenStreamsUid;
- (void)rtcManager:(EduSmallClassRTCManager *_Nonnull)rtcManager reportAllAudioVolume:(NSDictionary<NSString *, NSNumber *> *_Nonnull)volumeInfo;
@end

@interface EduSmallClassRTCManager : BaseRTCManager

@property (nonatomic, weak) id<EduSmallClassRTCManagerDelegate> _Nullable delegate;
 ...
 */
- (void)joinChannelWithSession:(EduSCRoomVideoSession *_Nullable)videoSession token:(NSString *_Nullable)token;
