...
#import "EduSCFeedbackInputView.h"
#import "EduSmallClassRTCManager.h"

@interface EduSCFeedbackView ()
...
@property (nonatomic, strong) EduSCFeedbackInputView *collectOpinionsTextField;
...
@implementation EduSCFeedbackView
...
- (void)initFeedBackUIComponent {
    ...
    self.collectOpinionsTextField = [[EduSCFeedbackInputView alloc] init];
