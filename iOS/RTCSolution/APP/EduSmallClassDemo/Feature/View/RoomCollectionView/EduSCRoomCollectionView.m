...
#import "EduSCRoomCollectionViewLayout.h"
#import "Masonry.h"
#import "Constants.h"
#import "EduSCRoomViewModel+Sort.h"

@interface EduSCRoomCollectionView()<UICollectionViewDelegate>

@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) UIPageControl *pageControl;
@property (nonatomic, strong) EduSCRoomCollectionViewDataSource *dataSource;
@property (nonatomic, strong) EduSCRoomCollectionViewLayout* collectionViewLayout;
...
@implementation EduSCRoomCollectionView
...
//        self.foldMode = EduSCRoomCollectionViewFoldModeHide;
    }
    return self;
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[EduSCRoomCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([EduSCRoomCollectionViewCell class])];
    }
    return _collectionView;
}

- (EduSCRoomCollectionViewDataSource *)dataSource {
    if (!_dataSource) {
        _dataSource = [[EduSCRoomCollectionViewDataSource alloc] init];
    }
    return _dataSource;
}

- (EduSCRoomCollectionViewLayout *)collectionViewLayout {
    if (!_collectionViewLayout) {
        _collectionViewLayout = [[EduSCRoomCollectionViewLayout alloc] init];
