...
@interface EduSCRoomParamInfoView ()
...
@implementation EduSCRoomParamInfoView
...
- (void)setParamInfoModel:(EduSCRoomParamInfoModel *)paramInfoModel {
    _paramInfoModel = paramInfoModel;

}

- (NSString *)getMeessageWithModel:(EduSCRoomParamInfoModel *)paramInfoModel index:(NSInteger)index {
    NSString *str = @"";
    switch (index) {
        case 0:
            str = @"[LOCAL]";
