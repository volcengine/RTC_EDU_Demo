 ...
 */
+ (void)joinMeeting:(RoomVideoSession *)session block:(void (^)(int resultCode, MeetingControlRoomModel *roomModel, NSArray<RoomVideoSession *> *userLists))block;
 ...
 * @param block Callback
 */
+ (void)onUserLeaveMeeting:(void (^)(MeetingControlUserModel *model))block;
