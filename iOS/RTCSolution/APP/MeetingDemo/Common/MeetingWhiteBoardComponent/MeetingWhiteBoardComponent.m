...
@interface MeetingWhiteBoardComponent() <ByteWhiteBoardRoomDelegate, ByteWhiteBoardDelegate>
@property (nonatomic, strong) RoomWhiteBoardView *whiteBoardView;
...
@implementation MeetingWhiteBoardComponent
