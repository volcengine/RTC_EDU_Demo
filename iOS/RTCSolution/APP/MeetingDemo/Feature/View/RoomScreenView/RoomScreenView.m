...
@property (nonatomic, strong) RoomUserView *screenVideoView;
...
- (void)setSharingVideoSession:(RoomVideoSession *)sharingVideoSession {
...
- (RoomUserView *)screenVideoView {
    if (!_screenVideoView) {
        _screenVideoView = [[RoomUserView alloc] init];
...
//            RoomItemButton *button = (RoomItemButton *)sender;
////            if ([wself.delegate respondsToSelector:@selector(roomBottomView:itemButton:didSelectStatus:)]) {
////                [wself.delegate roomBottomView:wself itemButton:button didSelectStatus:RoomBottomItemMic];
////            }
//        }];
//    }
    return nil;
