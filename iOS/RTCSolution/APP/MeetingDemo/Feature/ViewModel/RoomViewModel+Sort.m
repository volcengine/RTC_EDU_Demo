...
@implementation RoomViewModel (Sort)
...
- (void)sortEndCallbackWithBlock:(void (^)(NSMutableArray *userLists))block {
    NSArray *sortedNameArray = [[self getUserList] sortedArrayUsingComparator:^NSComparisonResult(RoomVideoSession *  _Nonnull obj1, RoomVideoSession *  _Nonnull obj2) {
