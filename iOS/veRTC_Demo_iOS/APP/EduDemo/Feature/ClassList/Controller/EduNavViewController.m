...
@interface EduNavViewController ()<UIGestureRecognizerDelegate>
...
@implementation EduNavViewController
...
- (void)viewDidLoad {
    ...
    [self addConstraints];
    self.bgView.backgroundColor = [UIColor colorFromHexString:@"#1D2129"];
}
